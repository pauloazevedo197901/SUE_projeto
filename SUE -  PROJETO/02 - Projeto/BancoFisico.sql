...
CREATE TABLE IF NOT EXISTS `sakila`.`Coordenador` (
...
CREATE TABLE IF NOT EXISTS `sakila`.`Curso` (
  ...
  PRIMARY KEY (`idCurso`, `Coordenador_idCoordenador`),
  ...
  CONSTRAINT `fk_Curso_Coordenador1`
    ...
    REFERENCES `sakila`.`Coordenador` (`idCoordenador`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;

CREATE TABLE IF NOT EXISTS `sakila`.`Aluno_has_Turma` (
  `Aluno_idAluno` INT(11) NOT NULL,
  `Turma_Id_Turma` INT(11) NOT NULL,
  PRIMARY KEY (`Aluno_idAluno`, `Turma_Id_Turma`),
  ...
  CONSTRAINT `fk_Aluno_has_Turma_Aluno1`
    ...
    REFERENCES `sakila`.`Aluno` (`idAluno`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Aluno_has_Turma_Turma1`
    FOREIGN KEY (`Turma_Id_Turma`)
    REFERENCES `sakila`.`Turma` (`Id_Turma`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;

CREATE TABLE IF NOT EXISTS `sakila`.`Turma_has_Curso` (
  `Turma_Id_Turma` INT(11) NOT NULL,
  `Curso_idCurso` INT(11) NOT NULL,
  PRIMARY KEY (`Turma_Id_Turma`, `Curso_idCurso`),
  INDEX `fk_Turma_has_Curso_Curso1_idx` (`Curso_idCurso` ASC),
  INDEX `fk_Turma_has_Curso_Turma1_idx` (`Turma_Id_Turma` ASC),
  ...
  CONSTRAINT `fk_Turma_has_Curso_Curso1`
    ...
    REFERENCES `sakila`.`Curso` (`idCurso`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;

CREATE TABLE IF NOT EXISTS `sakila`.`Curso_has_Disciplina` (
  `Curso_idCurso` INT(11) NOT NULL,
  ...
  CONSTRAINT `fk_Curso_has_Disciplina_Disciplina1`
    ...
    REFERENCES `sakila`.`Disciplina` (`idDisciplina`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;

CREATE TABLE IF NOT EXISTS `sakila`.`Professor_has_Disciplina` (
  ...
  CONSTRAINT `fk_Professor_has_Disciplina_Professor1`
    ...
    REFERENCES `sakila`.`Professor` (`idProfessor`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
